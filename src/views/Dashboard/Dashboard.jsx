    ...
    return (
      ...
      <div>
        <GridContainer>
          <GridItem>
              <CardBody>
                <h4 className={classes.cardTitle}>Publish Your Creation</h4>

            <div>
            <form onSubmit={this.uploadVideo} classname="form">
                 
                <input type="file" onChange={this.captureFile} className="km-btn-file" /> 
...
{/*             
           ...
           <GridItem>
              <CardBody>
                <h4 className={classes.cardTitle}>Varius sit sed viverra </h4>
